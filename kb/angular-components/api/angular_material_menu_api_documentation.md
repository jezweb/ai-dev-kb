# Angular Material Menu API Documentation

**Summary:** This file covers topics related to "Angular Material Menu API Documentation". Key snippets include: Angular Material Menu Component API Type Definitions.

---

## Angular Material Menu Component API Type Definitions

**Description:** Complete TypeScript interface and class definitions for Angular Material's menu component. Includes MatMenu, MatMenuItem, MatMenuTrigger, and supporting tokens and interfaces. Generated by API Extractor.
