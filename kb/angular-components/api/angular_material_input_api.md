# Angular Material Input API

**Summary:** This file covers topics related to "Angular Material Input API". Key snippets include: Angular Material Input API Definition.

---

## Angular Material Input API Definition

**Description:** Complete API report for @angular/material_input, generated by API Extractor. Defines all public classes, interfaces, and tokens including MatInput, MatFormField, MatError, and MatHint, along with supporting types and utilities.
